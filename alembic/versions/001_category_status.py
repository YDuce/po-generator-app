...
def upgrade():
    ...
    if op.get_context().dialect.name == "postgresql":
        ...
        END$$;
        """)
        porf_status_type = postgresql.ENUM('draft', 'approved', 'expired', name='porfstatus', create_type=False)
        po_status_type = postgresql.ENUM('open', 'expired', name='postatus', create_type=False)
    else:
    ...
    op.create_index('ix_product_category_category_id_product_id', 'product_category', ['category_id', 'product_id'])
    op.create_table(
        'porf',
        sa.Column('id', sa.Integer, primary_key=True),
...
def downgrade():
    ...
    op.drop_table('po')
    op.drop_table('porf')
    op.drop_index('ix_product_category_category_id_product_id', table_name='product_category')
